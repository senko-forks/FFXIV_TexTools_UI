...
{
    // Transfers textures between DX9 and DX11 using the CPU rather than relying on resource sharing APIs
    class DX11CanvasRenderer
    {
        private Texture2D stagingTexture = null;
        private ImageBrush canvasBrush = null;
        private WriteableBitmap canvasBitmap = null;

        public DX11CanvasRenderer(Viewport3DX viewport3DX, Canvas alternateViewportCanvas)
        {
